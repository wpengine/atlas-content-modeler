		...
		<div className={editing ? "field read-only editing" : "field"}>
			...
			<div className="d-flex flex-column d-sm-flex flex-sm-row">
				<div className="">
					...
					<br />
					<p className="help">
						Display name for your {supportedFields[type]} option.
					</p>
					<div
						className={`${
			...
			<div className="field">
				<button>
					<a><AddIcon size="small"/> <span>Add another option</span></a>
				</button>
			</div>
			<fieldset>
			<div className="field">
				...
				<div className="radio-row">
					...
					<label className="radio" htmlFor="integer">
						Single Select
						<span>Select this if you need a list of radio buttons (single selection)</span>
					</label>
				</div>
				<div className="radio-row">
					<input
					...
					<label className="radio" htmlFor="decimal">
						Multi Select
						<span>Select this if you need a list of checkboxes (multiple selections)</span>
					</label>
				</div>
			</div>
			</fieldset>

...
final class FormEditingExperience {
	...
	public function enqueue_assets( string $hook ): void {
		...
		wp_register_script(
			...
			[ 'react', 'react-dom', 'wp-tinymce', 'wp-i18n', 'wp-api-fetch', 'wp-date', 'wp-block-editor', 'wp-block-library', 'wp-components', 'wp-element', 'wp-keyboard-shortcuts', 'wp-block-directory' ],
			$plugin['Version'],
			true
		);

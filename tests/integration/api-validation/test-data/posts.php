 ...
 */
 ...
 function create_test_posts( $test_class ) {
    ...
    $ids['public_post_id'] = $test_class->factory->post->create( array(
        'post_title' => 'Test dog',
    ...
    $ids['public_fields_post_id'] = $test_class->factory->post->create( array(
    ...
    $ids['private_post_id'] = $test_class->factory->post->create( array(
        'post_title' => 'Test cat',
...
function populate_post( $post_id, $model, $test_class ) {
    ...
    $ids[$model . '_image_id'] = $test_class->factory->attachment->create( array(
        'post_mime_type' => 'image/png',
        'post_title' => 'Image Attachment',
    ) );

    $ids[$model . '_pdf_id'] = $test_class->factory->attachment->create( array(

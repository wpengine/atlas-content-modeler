...
== Description ==
Atlas Content Modeler (ACM) is a content modeling solution for WordPress. Using the intuitive interface, you can create custom post types, as well as custom fields and taxonomies for those post types, with ease.
...
1. Log in to your WordPress site and navigate to _Plugins &rarr; Add New.
...
2. Log in to your WordPress site and navigate to _Plugins &rarr; Add New.
